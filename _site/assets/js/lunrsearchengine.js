...
var documents = [{
    ...
    "id": 8,
    "url": "/jekyll-theme-memoirs/page3/",
    "title": "Home",
    "body": "  {% for post in paginator. posts %}    {% include postbox. html %}  {% endfor %}  {% include pagination. html %}"
    }, {
    "id": 9,
    "url": "/jekyll-theme-memoirs/My-First-Post/",
    "title": "My First Post",
    "body": "2021/11/30 - 안녕하세요, 오영주입니다. 이 포스트는 저의 처음이자 테스트 포스트입니다. 앞으로 잘 부탁드립니다.  Hello my name is YoungJoo Oh, this is my first and test post! "
    }, {
    "id": 10,
